...
// Cross Module References
	...
	BATTLETANK_API UFunction* Z_Construct_UFunction_ATank_GetCurrentHealth();
...
// End Cross Module References
	...
	void ATank::StaticRegisterNativesATank()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "GetCurrentHealth", &ATank::execGetCurrentHealth },
			{ "GetHealthPercent", &ATank::execGetHealthPercent },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_ATank_GetCurrentHealth_Statics
	{
		struct Tank_eventGetCurrentHealth_Parms
		{
			int32 ReturnValue;
		};
	...
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(Tank_eventGetCurrentHealth_Parms, ReturnValue), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::Function_MetaDataParams[] = {
		{ "Category", "Health" },
		{ "ModuleRelativePath", "Public/Tank.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ATank, nullptr, "GetCurrentHealth", sizeof(Tank_eventGetCurrentHealth_Parms), Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::PropPointers, ARRAY_COUNT(Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x54020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::Function_MetaDataParams, ARRAY_COUNT(Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ATank_GetCurrentHealth()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_ATank_GetCurrentHealth_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ATank_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ATank_GetCurrentHealth, "GetCurrentHealth" }, // 4006404520
	...
	IMPLEMENT_CLASS(ATank, 630710050);
